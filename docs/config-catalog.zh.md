...
来源：[`packages/workflow/tool-vibe-workflow/src/index.ts:33`](../packages/workflow/tool-vibe-workflow/src/index.ts)
...
- `@deepseek-ai/dsh-agent-modes`（[`packages/context/agent-modes/src/index.ts`](../packages/context/agent-modes/src/index.ts)）
...
- `@deepseek-ai/dsh-client-ui-desktop-decoration`（[`packages/client/ui-desktop-decoration/src/index.ts`](../packages/client/ui-desktop-decoration/src/index.ts)）
...
- `@deepseek-ai/dsh-client-ui-mode-switcher`（[`packages/client/ui-mode-switcher/src/index.ts`](../packages/client/ui-mode-switcher/src/index.ts)）
...
- `@deepseek-ai/dsh-client-ui-usage-dashboard`（[`packages/client/ui-usage-dashboard/src/index.ts`](../packages/client/ui-usage-dashboard/src/index.ts)）
...
- `@deepseek-ai/dsh-host-usage-dashboard` — 需要 `sessionPersistence`（[`packages/host/usage-dashboard/src/index.ts`](../packages/host/usage-dashboard/src/index.ts)）
