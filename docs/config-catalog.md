...
Source: [`packages/extensions/extensions-center/src/index.ts:32`](../packages/extensions/extensions-center/src/index.ts)
...
- `@deepseek-ai/dsh-host-usage-dashboard` — requires `sessionPersistence` ([`packages/host/usage-dashboard/src/index.ts`](../packages/host/usage-dashboard/src/index.ts))
